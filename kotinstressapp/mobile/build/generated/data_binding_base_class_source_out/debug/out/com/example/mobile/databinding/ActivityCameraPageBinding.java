...
package com.example.mobile.databinding;
...
public final class ActivityCameraPageBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityCameraPageBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityCameraPageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityCameraPageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_camera_page, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityCameraPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCameraPageBinding((ConstraintLayout) rootView, imageCaptureButton,
